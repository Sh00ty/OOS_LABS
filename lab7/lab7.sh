...
PS3='Введите ваш выбор: '
options=("Вывести таблицу файловых систем" "Монтировать файловую систему"\
 "Отмонтировать файловую систему" "Изменить параметры примонтированной файловой системы" \
 "Вывести параметры примонтированной файловой системы"\
...
do
    ...
    "Изменить параметры примонтированной файловой системы")
